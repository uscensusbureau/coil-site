...
active-challenges:
  - active-challenge-one:
    ...
    details: The Address Geolocation Challenge seeks to innovate the ways the Census Bureau geolocates residential addresses in rural and remote locations. Stay tuned for opportunities to apply to Phase 1 of this competition in early 2024. [Join an information session](https://statventuresgeolocationinfosessions.splashthat.com/) to learn how to participate in Phase 1. [Learn More](SITE.BASEURL/assets/files/statventures-geolocation-challenge-overview.pdf) for opportunities to apply in early 2024.
